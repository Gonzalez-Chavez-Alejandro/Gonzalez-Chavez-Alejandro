...
<img src="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExdTc3aTI1aWoxNDBscGpkYThjb25qbjNoaG8yZ2oxOWpmY2dpa3RzdCZlcD12MV9zdGlja2Vyc19zZWFyY2gmY3Q9cw/WFZvB7VIXBgiz3oDXE/giphy.gif" width="120"/>

# ¡Hola! 👋 Soy Alejandro González Chávez

### 🚀 Desarrollador Full Stack

Apasionado por el desarrollo web, la creación de sistemas escalables y el diseño de experiencias digitales modernas.
...
* 🔐 Implementación de APIs REST y autenticación con JWT.
...
Sistema completo de tienda en línea desarrollado con Django, autenticación JWT, gestión de productos, carrito de compras y seguimiento de pedidos.

### 💬 Sistema de Chat Cliente-Administrador

Aplicación de mensajería integrada para la comunicación entre clientes y administradores.

### 📦 Sistema de Gestión de Inventario

Administración de productos, categorías y existencias con panel de control y reportes.

### 📊 Dashboard de Reportes

Panel avanzado para visualización y análisis de datos desarrollado con Laravel.
